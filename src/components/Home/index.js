...
class Home extends Component {
    ...
    getItems() {
        ...
        axios.get(`${config.apiUrl}/getitems`, {
            ...
            data.map((item, index) => {
                markers[index] = { ...markers[index], label: item.item_name, value: item.item_name };
                this.setState({ testData: [...this.state.markers, markers] })
        ...
        return (
            <>
                <div className="canvas">
                    {/* {console.log(this.state.markers, this.state.testData)} */}
                    <Header />
                                    ...
                                    <div className="tab-col">
                                        <ul className="nav nav-tabs row text-center" id="mytab" role="tablist">
                                            <li className="nav-item col" role="presentation">
                                                <a className="nav-link p-3 active" id="stable-tab" href="#os4-stable" role="tab" aria-controls="pills-stable" aria-selected="true">SmallHD PageOS</a>
                                            </li>
                                            <li className="nav-item  col" role="presentation">
                                                <a className="nav-link  p-3" id="touch-tab" href={`/firmware/red-touch`} role="tab" aria-controls="pills-touch" aria-selected="false">RED® Touch</a>
                                            </li>
                                            <li className="nav-item  col" role="presentation">
                                        ...
                                        <div className="tab-content" id="myTabContent">
                                            <div className="tab-pane fade p-3 pt-4 active show" id="os4-stable" role="tabpanel" aria-labelledby="home-tab">
                                                <div className="row">
                                                    <div className={
                                                        !this.state.showSearchDetail ?
                                                        ...
                                                        !this.state.showSearchDetail ?
                                                            (this.state.dataList.length) ?
                                                                <div className="col-lg-4  mb-lg-5">
                                                                    <BetaFirmware showpopupdownload={this.showpopupdownload} />
                                                                </div>
                                                                : ''
                                                            : ''
                                                    }
                                            ...
                                            <div className="tab-pane fade p-3 pt-4" id="red-touch" role="tabpanel" aria-labelledby="home-tab">
                                                <RedTouchFirmware />
                                            </div>
                                                ...
                                                <div className="row align-items-center">
                                                    <div className="col-lg-12">
                                                        ...
                                                        <div className="btn-col">
                                                            <a href={ '/firmware/smallhdos/' + firmware.version} className="btn btn-outline-dark"  >Learn More</a>
                                                            <a onClick={() => {
                                                            ...
                                                            }} className="btn btn-primary text-white">Download</a>  </div>
                                                        {/* 
                              <a onClick={() => {
                                  props.hanldeDownloadBtnClick(config.downloadFirmwarePrefix+firmware.version+'.zip')
                                  console.log(config.downloadFirmwarePrefix+firmware.version+'.zip')
                              } 
                                                ...
                                                <div className="card-body">
                                                    <div className="row align-items-center">
                                                        <div className="col-lg-12">
                                                            ...
                                                            <div className="btn-col">
                                                                <a href={config.siteUrl + '/firmware/smallhdos/' + firmware.version} className="btn btn-outline-dark">Learn More</a>
                                                                <a onClick={() => {
                                                                    props.showpopupdownload(config.downloadFirmwareUrl + config.downloadFirmwarePrefix + firmware.version + '.zip', config.downloadFirmwarePrefix + firmware.version + '.zip');
                                        ...
                                        <div className="card-body">
                                            <div className="row align-items-center">
                                                <div className="col-lg-12">
                                                    ...
                                                    <div className="btn-col">
                                                        <a href={config.siteUrl + '/firmware/smallhdos/' + firmware.version} className="btn btn-outline-dark" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="info-01">Learn More</a>
                                                        <a onClick={() => {
                                                            props.showpopupdownload(config.downloadFirmwareUrl + config.downloadFirmwarePrefix + firmware.version + '.zip', config.downloadFirmwarePrefix + firmware.version + '.zip');
...
const getSuggestions = (value, itemsList) => {
    ...
    if (matched_items.length) {
        // this.setState({
        //     isserial:matched_items.length==1?true:false
        // })
